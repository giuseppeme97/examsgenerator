...
class MainFrame(wx.Frame):
    ...
    def task_error(self):
        self.stop_progress()
        self.show_dialog(self, self.text_error[1], self.text_error[0], wx.OK | wx.ICON_INFORMATION)


    def task_completed(self):
        self.stop_progress()
        self.show_dialog(self, self.text_complete[1], self.text_complete[0], wx.OK | wx.ICON_INFORMATION)
